 ...
 */
final class Version20211019070604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_sortie (user_id INTEGER NOT NULL, sortie_id INTEGER NOT NULL, PRIMARY KEY(user_id, sortie_id))');
        $this->addSql('CREATE INDEX IDX_596DC8CFA76ED395 ON user_sortie (user_id)');
        $this->addSql('CREATE INDEX IDX_596DC8CFCC72D953 ON user_sortie (sortie_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, etat_id INTEGER NOT NULL, lieu_id_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, date_heure_sortie DATETIME NOT NULL, date_limite DATETIME NOT NULL, nb_place INTEGER NOT NULL, duree INTEGER NOT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO sortie (id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description) SELECT id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description FROM __temp__sortie');
        $this->addSql('DROP TABLE __temp__sortie');
        $this->addSql('CREATE INDEX IDX_3C3FD3F2D5E86FF ON sortie (etat_id)');
        $this->addSql('CREATE INDEX IDX_3C3FD3F2BA74394C ON sortie (lieu_id_id)');
