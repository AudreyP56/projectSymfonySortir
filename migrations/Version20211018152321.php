 ...
 */
final class Version20211018152321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, etat_id INTEGER NOT NULL, lieu_id_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, date_heure_sortie DATETIME NOT NULL, date_limite DATETIME NOT NULL, nb_place INTEGER NOT NULL, duree INTEGER NOT NULL, description CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_3C3FD3F2D5E86FF FOREIGN KEY (etat_id) REFERENCES etat (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3C3FD3F2BA74394C FOREIGN KEY (lieu_id_id) REFERENCES lieu (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sortie (id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description) SELECT id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description FROM __temp__sortie');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, site_id_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, pseudo VARCHAR(255) NOT NULL COLLATE BINARY, telephone VARCHAR(10) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, photo VARCHAR(255) DEFAULT NULL COLLATE BINARY, role CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        )');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, etat_id INTEGER NOT NULL, lieu_id_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, date_heure_sortie DATETIME NOT NULL, date_limite DATETIME NOT NULL, nb_place INTEGER NOT NULL, duree INTEGER NOT NULL, description CLOB DEFAULT NULL, organisateur_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO sortie (id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description) SELECT id, etat_id, lieu_id_id, nom, date_heure_sortie, date_limite, nb_place, duree, description FROM __temp__sortie');
        $this->addSql('DROP TABLE __temp__sortie');
        $this->addSql('CREATE INDEX IDX_3C3FD3F2D5E86FF ON sortie (etat_id)');
        $this->addSql('CREATE INDEX IDX_3C3FD3F2BA74394C ON sortie (lieu_id_id)');
